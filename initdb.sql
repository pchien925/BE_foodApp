...
(1, 'Pizza Phô Mai Classic', NOW(), NOW(), 'Sốt cà chua, phô mai Mozzarella tan chảy.', 'https://via.placeholder.com/300x200?text=Pizza+Pho+Mai', 8.99, 1, 1),
(2, 'Pizza Pepperoni Supreme', NOW(), NOW(), 'Xúc xích Pepperoni cay nồng phủ kín mặt bánh.', 'https://via.placeholder.com/300x200?text=Pizza+Pepperoni', 9.99, 1, 1),
(3, 'Pizza Thịt Nguội & Nấm', NOW(), NOW(), 'Kết hợp thịt nguội, nấm tươi và phô mai.', 'https://via.placeholder.com/300x200?text=Pizza+Ham+Mushroom', 10.49, 1, 1),
(4, 'Pizza Hải Sản Nhiệt Đới', NOW(), NOW(), 'Tôm, mực, thanh cua, thơm, sốt Thousand Island.', 'https://via.placeholder.com/300x200?text=Pizza+Seafood', 12.99, 1, 1),
(5, 'Pizza Gà BBQ', NOW(), NOW(), 'Thịt gà, sốt BBQ, hành tây, ớt chuông.', 'https://via.placeholder.com/300x200?text=Pizza+BBQ+Chicken', 11.49, 1, 1),
(6, 'Pizza Rau Củ Tổng Hợp', NOW(), NOW(), 'Nấm, ớt chuông, hành tây, ô liu, cà chua.', 'https://via.placeholder.com/300x200?text=Pizza+Veggie', 9.49, 1, 1),
(7, 'Pizza Xúc Xích Ý & Hành Tây', NOW(), NOW(), 'Xúc xích Ý cay nhẹ, hành tây và phô mai.', 'https://via.placeholder.com/300x200?text=Pizza+Sausage+Onion', 10.99, 1, 1),
(8, 'Pizza 4 Loại Phô Mai', NOW(), NOW(), 'Mozzarella, Cheddar, Parmesan, Blue Cheese.', 'https://via.placeholder.com/300x200?text=Pizza+4+Cheese', 11.99, 1, 1),
(9, 'Pizza Hawaii', NOW(), NOW(), 'Thịt nguội, thơm, phô mai.', 'https://via.placeholder.com/300x200?text=Pizza+Hawaiian', 10.49, 1, 1),
(10, 'Pizza Bò Bằm & Ngô', NOW(), NOW(), 'Thịt bò bằm, ngô ngọt, hành tây, phô mai.', 'https://via.placeholder.com/300x200?text=Pizza+Beef+Corn', 11.49, 1, 1),
(11, 'Pizza Gà Nấm Sốt Kem', NOW(), NOW(), 'Thịt gà, nấm, sốt kem trắng Alfredo.', 'https://via.placeholder.com/300x200?text=Pizza+Chicken+Alfredo', 11.99, 1, 1),
(12, 'Pizza Cay Kiểu Mexico', NOW(), NOW(), 'Thịt bò bằm cay, đậu đỏ, hành tây, ớt jalapeno.', 'https://via.placeholder.com/300x200?text=Pizza+Mexican', 11.99, 1, 1),
(13, 'Pizza Cá Ngừ & Ô Liu', NOW(), NOW(), 'Cá ngừ ngâm dầu, ô liu đen, hành tây.', 'https://via.placeholder.com/300x200?text=Pizza+Tuna+Olive', 10.99, 1, 1),
(14, 'Pizza Thịt Xông Khói', NOW(), NOW(), 'Thịt xông khói giòn rụm phủ phô mai.', 'https://via.placeholder.com/300x200?text=Pizza+Bacon', 10.99, 1, 1),
(15, 'Pizza Pesto Gà', NOW(), NOW(), 'Sốt Pesto, thịt gà nướng, cà chua bi.', 'https://via.placeholder.com/300x200?text=Pizza+Pesto+Chicken', 11.99, 1, 1),
(16, 'Pizza Phô Mai Dê & Rau Bina', NOW(), NOW(), 'Phô mai dê, rau bina (spinach), tỏi.', 'https://via.placeholder.com/300x200?text=Pizza+Goat+Cheese', 12.49, 1, 1),
(17, 'Pizza Margherita Đặc Biệt', NOW(), NOW(), 'Cà chua tươi, phô mai Mozzarella tươi, lá húng quế.', 'https://via.placeholder.com/300x200?text=Pizza+Margherita', 10.49, 1, 1),
(18, 'Pizza Sốt Trứng Muối Hải Sản', NOW(), NOW(), 'Sốt trứng muối đặc biệt, tôm, mực.', 'https://via.placeholder.com/300x200?text=Pizza+Salted+Egg', 13.49, 1, 1),
(19, 'Pizza Thập Cẩm (The Works)', NOW(), NOW(), 'Pepperoni, thịt nguội, bò bằm, nấm, ớt, hành tây, ô liu.', 'https://via.placeholder.com/300x200?text=Pizza+The+Works', 13.99, 1, 1),
(20, 'Pizza Đế Mỏng Giòn (Chọn Nhân)', NOW(), NOW(), 'Đế bánh siêu mỏng giòn, chọn 2 loại nhân.', 'https://via.placeholder.com/300x200?text=Pizza+Thin+Crust', 10.99, 1, 1),

-- Danh mục 2: HAMBURGER (menu_category_id = 2)
(21, 'Classic Beef Burger', NOW(), NOW(), 'Bò Mỹ, rau diếp, cà chua, hành tây, sốt burger.', 'https://via.placeholder.com/300x200?text=Classic+Burger', 4.99, 1, 2),
(22, 'Cheeseburger', NOW(), NOW(), 'Bò Mỹ, phô mai American, rau diếp, cà chua, sốt.', 'https://via.placeholder.com/300x200?text=Cheeseburger', 5.49, 1, 2),
(23, 'Double Cheeseburger', NOW(), NOW(), '2 lớp bò Mỹ, 2 lớp phô mai American, rau, sốt.', 'https://via.placeholder.com/300x200?text=Double+Cheeseburger', 7.49, 1, 2),
(24, 'Bacon Cheeseburger', NOW(), NOW(), 'Bò Mỹ, phô mai American, thịt xông khói giòn.', 'https://via.placeholder.com/300x200?text=Bacon+Cheeseburger', 6.49, 1, 2),
(25, 'Mushroom Swiss Burger', NOW(), NOW(), 'Bò Mỹ, nấm xào, phô mai Thụy Sĩ, sốt kem nấm.', 'https://via.placeholder.com/300x200?text=Mushroom+Burger', 6.99, 1, 2),
(26, 'Crispy Chicken Burger', NOW(), NOW(), 'Gà phi lê chiên giòn, rau diếp, sốt mayonnaise.', 'https://via.placeholder.com/300x200?text=Crispy+Chicken+Burger', 5.99, 1, 2),
(27, 'Spicy Chicken Burger', NOW(), NOW(), 'Gà phi lê chiên giòn cay, rau diếp, sốt cay.', 'https://via.placeholder.com/300x200?text=Spicy+Chicken+Burger', 6.29, 1, 2),
(28, 'Grilled Chicken Burger', NOW(), NOW(), 'Gà phi lê nướng, rau diếp, cà chua, sốt.', 'https://via.placeholder.com/300x200?text=Grilled+Chicken+Burger', 6.49, 1, 2),
(29, 'Fish Burger', NOW(), NOW(), 'Cá phi lê tẩm bột chiên, sốt tartar, phô mai.', 'https://via.placeholder.com/300x200?text=Fish+Burger', 5.49, 1, 2),
(30, 'Veggie Burger', NOW(), NOW(), 'Nhân rau củ chiên, rau diếp, cà chua, sốt.', 'https://via.placeholder.com/300x200?text=Veggie+Burger', 5.99, 1, 2),
(31, 'BBQ Bacon Burger', NOW(), NOW(), 'Bò Mỹ, thịt xông khói, sốt BBQ, hành tây chiên giòn.', 'https://via.placeholder.com/300x200?text=BBQ+Bacon+Burger', 6.99, 1, 2),
(32, 'Jalapeno Burger', NOW(), NOW(), 'Bò Mỹ, phô mai Pepper Jack, ớt Jalapeno ngâm.', 'https://via.placeholder.com/300x200?text=Jalapeno+Burger', 6.49, 1, 2),
(33, 'Blue Cheese Burger', NOW(), NOW(), 'Bò Mỹ, phô mai xanh (Blue Cheese), hành tây caramel.', 'https://via.placeholder.com/300x200?text=Blue+Cheese+Burger', 7.29, 1, 2),
(34, 'Teriyaki Burger', NOW(), NOW(), 'Bò Mỹ hoặc gà, sốt Teriyaki, lát thơm nướng.', 'https://via.placeholder.com/300x200?text=Teriyaki+Burger', 6.79, 1, 2),
(35, 'Breakfast Burger', NOW(), NOW(), 'Bò Mỹ, trứng ốp la, thịt xông khói, phô mai.', 'https://via.placeholder.com/300x200?text=Breakfast+Burger', 7.49, 1, 2),
(36, 'Slider Trio (Mini Burgers)', NOW(), NOW(), 'Bộ 3 burger nhỏ: bò, gà, phô mai.', 'https://via.placeholder.com/300x200?text=Slider+Trio', 8.99, 1, 2),
(37, 'Tower Burger', NOW(), NOW(), '2 lớp bò, 1 lớp gà chiên giòn, phô mai, bacon, hành tây chiên.', 'https://via.placeholder.com/300x200?text=Tower+Burger', 9.99, 1, 2),
(38, 'Hawaiian Chicken Burger', NOW(), NOW(), 'Gà nướng, lát thơm nướng, sốt teriyaki.', 'https://via.placeholder.com/300x200?text=Hawaiian+Chicken+Burger', 6.99, 1, 2),
(39, 'Avocado Burger', NOW(), NOW(), 'Bò Mỹ, lát bơ tươi, hành tây đỏ, rau mầm.', 'https://via.placeholder.com/300x200?text=Avocado+Burger', 7.49, 1, 2),
(40, 'Burger Gà Sốt Nấm', NOW(), NOW(), 'Gà nướng, sốt kem nấm, phô mai Thụy Sĩ.', 'https://via.placeholder.com/300x200?text=Chicken+Mushroom+Burger', 6.99, 1, 2),

-- Danh mục 3: SPAGHETTI (menu_category_id = 3)
(41, 'Spaghetti Bolognese', NOW(), NOW(), 'Mì Ý sốt bò bằm cà chua cổ điển.', 'https://via.placeholder.com/300x200?text=Spaghetti+Bolognese', 6.99, 1, 3),
(42, 'Spaghetti Carbonara', NOW(), NOW(), 'Mì Ý sốt kem trứng và thịt xông khói.', 'https://via.placeholder.com/300x200?text=Spaghetti+Carbonara', 7.49, 1, 3),
(43, 'Spaghetti Sốt Kem Gà Nấm', NOW(), NOW(), 'Mì Ý sốt kem, thịt gà, nấm tươi.', 'https://via.placeholder.com/300x200?text=Spaghetti+Chicken+Alfredo', 7.99, 1, 3),
(44, 'Spaghetti Hải Sản Sốt Cà Chua', NOW(), NOW(), 'Mì Ý sốt cà chua, tôm, mực, nghêu.', 'https://via.placeholder.com/300x200?text=Spaghetti+Seafood+Tomato', 8.99, 1, 3),
(45, 'Spaghetti Sốt Kem Hải Sản', NOW(), NOW(), 'Mì Ý sốt kem, tôm, mực, nghêu.', 'https://via.placeholder.com/300x200?text=Spaghetti+Seafood+Cream', 9.49, 1, 3),
(46, 'Spaghetti Aglio e Olio', NOW(), NOW(), 'Mì Ý xào tỏi, dầu ô liu, ớt khô (cay nhẹ).', 'https://via.placeholder.com/300x200?text=Spaghetti+Aglio+Olio', 5.99, 1, 3),
(47, 'Spaghetti Aglio e Olio Tôm', NOW(), NOW(), 'Mì Ý xào tỏi ớt với tôm tươi.', 'https://via.placeholder.com/300x200?text=Spaghetti+Aglio+Olio+Shrimp', 8.49, 1, 3),
(48, 'Spaghetti Sốt Pesto', NOW(), NOW(), 'Mì Ý sốt lá húng quế Pesto.', 'https://via.placeholder.com/300x200?text=Spaghetti+Pesto', 6.99, 1, 3),
(49, 'Spaghetti Sốt Pesto Gà', NOW(), NOW(), 'Mì Ý sốt Pesto với thịt gà nướng.', 'https://via.placeholder.com/300x200?text=Spaghetti+Pesto+Chicken', 8.49, 1, 3),
(50, 'Spaghetti Meatballs', NOW(), NOW(), 'Mì Ý sốt cà chua với thịt viên bò.', 'https://via.placeholder.com/300x200?text=Spaghetti+Meatballs', 7.99, 1, 3),
(51, 'Spaghetti Puttanesca', NOW(), NOW(), 'Mì Ý sốt cà chua, ô liu, nụ bạch hoa, cá cơm.', 'https://via.placeholder.com/300x200?text=Spaghetti+Puttanesca', 7.99, 1, 3),
(52, 'Spaghetti Arrabbiata', NOW(), NOW(), 'Mì Ý sốt cà chua cay nồng.', 'https://via.placeholder.com/300x200?text=Spaghetti+Arrabbiata', 6.49, 1, 3),
(53, 'Spaghetti Vẹm Xanh Sốt Rượu Vang', NOW(), NOW(), 'Mì Ý xào vẹm xanh, tỏi, rượu vang trắng.', 'https://via.placeholder.com/300x200?text=Spaghetti+Mussels', 9.99, 1, 3),
(54, 'Spaghetti Cá Hồi Sốt Kem', NOW(), NOW(), 'Mì Ý sốt kem với phi lê cá hồi áp chảo.', 'https://via.placeholder.com/300x200?text=Spaghetti+Salmon+Cream', 10.99, 1, 3),
(55, 'Spaghetti Bò Lúc Lắc', NOW(), NOW(), 'Mì Ý xào với thịt bò thái hạt lựu kiểu Việt.', 'https://via.placeholder.com/300x200?text=Spaghetti+Bo+Luc+Lac', 8.99, 1, 3),
(56, 'Spaghetti Đút Lò Phô Mai', NOW(), NOW(), 'Mì Ý Bolognese phủ phô mai đút lò.', 'https://via.placeholder.com/300x200?text=Spaghetti+Baked', 8.49, 1, 3),
(57, 'Spaghetti Sốt Cà Ri Gà', NOW(), NOW(), 'Mì Ý sốt cà ri kiểu Nhật với thịt gà.', 'https://via.placeholder.com/300x200?text=Spaghetti+Curry+Chicken', 7.99, 1, 3),
(58, 'Spaghetti Rau Củ Sốt Kem', NOW(), NOW(), 'Mì Ý sốt kem với bông cải xanh, cà rốt, nấm.', 'https://via.placeholder.com/300x200?text=Spaghetti+Veggie+Cream', 6.99, 1, 3),
(59, 'Spaghetti Trứng Muối Tôm', NOW(), NOW(), 'Mì Ý sốt kem trứng muối với tôm tươi.', 'https://via.placeholder.com/300x200?text=Spaghetti+Salted+Egg+Shrimp', 9.99, 1, 3),
(60, 'Spaghetti Mực Đen', NOW(), NOW(), 'Mì Ý sốt mực đen đặc trưng của Ý.', 'https://via.placeholder.com/300x200?text=Spaghetti+Squid+Ink', 10.49, 1, 3),

-- Danh mục 4: FRIED CHICKEN (menu_category_id = 4)
(61, 'Gà Rán Giòn (1 Miếng)', NOW(), NOW(), '1 miếng gà giòn tan (chọn vị Original/Spicy).', 'https://via.placeholder.com/300x200?text=Fried+Chicken+1pc', 2.99, 1, 4),
(62, 'Gà Rán Giòn (2 Miếng)', NOW(), NOW(), '2 miếng gà giòn tan (chọn vị).', 'https://via.placeholder.com/300x200?text=Fried+Chicken+2pcs', 5.79, 1, 4),
(63, 'Gà Rán Giòn (3 Miếng)', NOW(), NOW(), '3 miếng gà giòn tan (chọn vị).', 'https://via.placeholder.com/300x200?text=Fried+Chicken+3pcs', 8.49, 1, 4),
(64, 'Combo Gà Rán 2 Miếng', NOW(), NOW(), '2 miếng gà, 1 Khoai tây (vừa), 1 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Combo+Chicken+2pcs', 8.99, 1, 4),
(65, 'Combo Gà Rán 3 Miếng', NOW(), NOW(), '3 miếng gà, 1 Khoai tây (vừa), 1 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Combo+Chicken+3pcs', 11.49, 1, 4),
(66, 'Xô Gà Rán (6 Miếng)', NOW(), NOW(), '6 miếng gà giòn (chọn vị hoặc mix).', 'https://via.placeholder.com/300x200?text=Bucket+Chicken+6pcs', 15.99, 1, 4),
(67, 'Xô Gà Rán (9 Miếng)', NOW(), NOW(), '9 miếng gà giòn (chọn vị hoặc mix).', 'https://via.placeholder.com/300x200?text=Bucket+Chicken+9pcs', 22.99, 1, 4),
(68, 'Xô Gà Gia Đình', NOW(), NOW(), '8 miếng gà, 2 Khoai tây (lớn), 1 Salad bắp cải, 4 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Bucket+Chicken+Family', 29.99, 1, 4),
(69, 'Cánh Gà Rán (3 cái)', NOW(), NOW(), '3 cánh gà chiên giòn (chọn vị).', 'https://via.placeholder.com/300x200?text=Chicken+Wings+3pcs', 4.49, 1, 4),
(70, 'Cánh Gà Rán (6 cái)', NOW(), NOW(), '6 cánh gà chiên giòn (chọn vị).', 'https://via.placeholder.com/300x200?text=Chicken+Wings+6pcs', 8.49, 1, 4),
(71, 'Đùi Gà Rán (1 cái)', NOW(), NOW(), '1 đùi gà chiên giòn (chọn vị).', 'https://via.placeholder.com/300x200?text=Chicken+Drumstick', 3.19, 1, 4),
(72, 'Gà Rán Không Xương (Popcorn)', NOW(), NOW(), 'Gà viên chiên giòn.', 'https://via.placeholder.com/300x200?text=Chicken+Popcorn', 4.99, 1, 4),
(73, 'Gà Rán Sốt Cay Ngọt Hàn Quốc (6 cánh)', NOW(), NOW(), '6 cánh gà giòn phủ sốt cay ngọt kiểu Hàn.', 'https://via.placeholder.com/300x200?text=Korean+Wings', 9.49, 1, 4),
(74, 'Gà Rán Sốt BBQ (6 cánh)', NOW(), NOW(), '6 cánh gà giòn phủ sốt BBQ đậm đà.', 'https://via.placeholder.com/300x200?text=BBQ+Wings', 9.49, 1, 4),
(75, 'Gà Rán Sốt Phô Mai (6 cánh)', NOW(), NOW(), '6 cánh gà giòn phủ sốt phô mai béo ngậy.', 'https://via.placeholder.com/300x200?text=Cheese+Wings', 9.99, 1, 4),
(76, 'Combo Gà Popcorn', NOW(), NOW(), '1 Gà Popcorn (vừa), 1 Khoai tây (vừa), 1 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Combo+Popcorn', 8.49, 1, 4),
(77, 'Gà Rán Mật Ong (1 Miếng)', NOW(), NOW(), '1 miếng gà giòn phủ sốt mật ong.', 'https://via.placeholder.com/300x200?text=Honey+Chicken', 3.29, 1, 4),
(78, 'Combo Cánh Gà', NOW(), NOW(), '5 cánh gà (chọn vị), 1 Khoai tây (vừa), 1 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Combo+Wings', 10.99, 1, 4),
(79, 'Ức Gà Rán Filet (1 miếng)', NOW(), NOW(), '1 miếng ức gà không xương chiên giòn.', 'https://via.placeholder.com/300x200?text=Chicken+Filet', 3.49, 1, 4),
(80, 'Xô Gà Tiệc Tùng', NOW(), NOW(), '12 miếng gà, 4 Khoai tây (vừa), 2 Gà Popcorn, 6 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Party+Bucket', 45.99, 1, 4),

-- Danh mục 5: SIDES (menu_category_id = 5)
(81, 'Khoai Tây Chiên', NOW(), NOW(), 'Khoai tây sợi chiên vàng giòn.', 'https://via.placeholder.com/300x200?text=Fries', 1.99, 1, 5),
(82, 'Khoai Tây Chiên Phô Mai', NOW(), NOW(), 'Khoai tây chiên phủ sốt phô mai nóng.', 'https://via.placeholder.com/300x200?text=Cheese+Fries', 2.99, 1, 5),
(83, 'Khoai Tây Chiên BBQ', NOW(), NOW(), 'Khoai tây chiên rắc bột gia vị BBQ.', 'https://via.placeholder.com/300x200?text=BBQ+Fries', 2.49, 1, 5),
(84, 'Hành Tây Chiên Giòn (Onion Rings)', NOW(), NOW(), 'Khoanh hành tây tẩm bột chiên giòn.', 'https://via.placeholder.com/300x200?text=Onion+Rings', 2.49, 1, 5),
(85, 'Phô Mai Que (4 que)', NOW(), NOW(), 'Phô mai Mozzarella chiên xù ăn kèm sốt cà chua.', 'https://via.placeholder.com/300x200?text=Mozzarella+Sticks', 3.49, 1, 5),
(86, 'Salad Bắp Cải Trộn', NOW(), NOW(), 'Bắp cải, cà rốt thái sợi trộn sốt mayonnaise.', 'https://via.placeholder.com/300x200?text=Coleslaw', 1.99, 1, 5),
(87, 'Khoai Tây Nghiền & Nước Sốt', NOW(), NOW(), 'Khoai tây nghiền mịn ăn kèm nước sốt thịt.', 'https://via.placeholder.com/300x200?text=Mashed+Potato', 2.49, 1, 5),
(88, 'Bánh Mì Bơ Tỏi', NOW(), NOW(), 'Bánh mì nướng bơ tỏi thơm lừng.', 'https://via.placeholder.com/300x200?text=Garlic+Bread', 2.29, 1, 5),
(89, 'Bánh Mì Bơ Tỏi Phô Mai', NOW(), NOW(), 'Bánh mì bơ tỏi phủ phô mai Mozzarella đút lò.', 'https://via.placeholder.com/300x200?text=Cheesy+Garlic+Bread', 3.29, 1, 5),
(90, 'Ngô Ngọt Hấp Bơ', NOW(), NOW(), 'Hạt ngô ngọt hấp với bơ.', 'https://via.placeholder.com/300x200?text=Corn', 1.99, 1, 5),
(91, 'Nấm Chiên Giòn', NOW(), NOW(), 'Nấm tươi tẩm bột chiên giòn.', 'https://via.placeholder.com/300x200?text=Fried+Mushrooms', 3.49, 1, 5),
(92, 'Khoai Tây Múi Cau', NOW(), NOW(), 'Khoai tây bổ múi cau chiên giòn.', 'https://via.placeholder.com/300x200?text=Potato+Wedges', 2.49, 1, 5),
(93, 'Jalapeno Poppers (4 cái)', NOW(), NOW(), 'Ớt Jalapeno nhồi phô mai chiên xù.', 'https://via.placeholder.com/300x200?text=Jalapeno+Poppers', 3.99, 1, 5),
(94, 'Bánh Xếp Chiên (Fried Dumplings - 4 cái)', NOW(), NOW(), 'Bánh xếp nhân thịt chiên giòn.', 'https://via.placeholder.com/300x200?text=Fried+Dumplings', 3.49, 1, 5),
(95, 'Chả Giò Mini (4 cuốn)', NOW(), NOW(), 'Chả giò nhỏ chiên giòn.', 'https://via.placeholder.com/300x200?text=Mini+Spring+Rolls', 3.29, 1, 5),
(96, 'Xúc Xích Đức Nướng', NOW(), NOW(), 'Xúc xích Đức nướng ăn kèm mù tạt.', 'https://via.placeholder.com/300x200?text=Grilled+Sausage', 2.99, 1, 5),
(97, 'Súp Kem Nấm', NOW(), NOW(), 'Súp kem nấm nóng hổi.', 'https://via.placeholder.com/300x200?text=Mushroom+Soup', 2.99, 1, 5),
(98, 'Súp Cà Chua', NOW(), NOW(), 'Súp cà chua kiểu Ý.', 'https://via.placeholder.com/300x200?text=Tomato+Soup', 2.79, 1, 5),
(99, 'Salad Trộn Dầu Giấm', NOW(), NOW(), 'Xà lách, cà chua, dưa leo, sốt dầu giấm.', 'https://via.placeholder.com/300x200?text=Garden+Salad', 2.99, 1, 5),
(100, 'Combo Ăn Kèm', NOW(), NOW(), '1 Khoai tây (vừa), 1 Salad bắp cải, 1 Nước ngọt (vừa).', 'https://via.placeholder.com/300x200?text=Combo+Sides', 4.99, 1, 5),

-- Danh mục 6: DRINKS (menu_category_id = 6)
(101, 'Coca-Cola', NOW(), NOW(), 'Nước ngọt có gas Coca-Cola.', 'https://via.placeholder.com/300x200?text=Coca-Cola', 1.49, 1, 6),
(102, 'Coca-Cola Light / Zero', NOW(), NOW(), 'Nước ngọt Coca-Cola không đường.', 'https://via.placeholder.com/300x200?text=Coke+Zero', 1.49, 1, 6),
(103, 'Pepsi', NOW(), NOW(), 'Nước ngọt có gas Pepsi.', 'https://via.placeholder.com/300x200?text=Pepsi', 1.49, 1, 6),
(104, 'Pepsi Light / Zero', NOW(), NOW(), 'Nước ngọt Pepsi không đường.', 'https://via.placeholder.com/300x200?text=Pepsi+Zero', 1.49, 1, 6),
(105, 'Sprite', NOW(), NOW(), 'Nước ngọt vị chanh Sprite.', 'https://via.placeholder.com/300x200?text=Sprite', 1.49, 1, 6),
(106, '7 Up', NOW(), NOW(), 'Nước ngọt vị chanh 7 Up.', 'https://via.placeholder.com/300x200?text=7+Up', 1.49, 1, 6),
(107, 'Fanta Cam', NOW(), NOW(), 'Nước ngọt vị cam Fanta.', 'https://via.placeholder.com/300x200?text=Fanta+Orange', 1.49, 1, 6),
(108, 'Fanta Xá Xị', NOW(), NOW(), 'Nước ngọt vị xá xị Fanta.', 'https://via.placeholder.com/300x200?text=Fanta+Sarsi', 1.49, 1, 6),
(109, 'Mirinda Kem Soda', NOW(), NOW(), 'Nước ngọt vị kem soda Mirinda.', 'https://via.placeholder.com/300x200?text=Mirinda+Soda+Cream', 1.49, 1, 6),
(110, 'Nước Suối Aquafina', NOW(), NOW(), 'Nước tinh khiết đóng chai.', 'https://via.placeholder.com/300x200?text=Aquafina', 0.99, 1, 6),
(111, 'Nước Suối Dasani', NOW(), NOW(), 'Nước tinh khiết đóng chai.', 'https://via.placeholder.com/300x200?text=Dasani', 0.99, 1, 6),
(112, 'Trà Chanh Lipton', NOW(), NOW(), 'Trà chanh đóng chai Lipton.', 'https://via.placeholder.com/300x200?text=Lipton+Lemon', 1.79, 1, 6),
(113, 'Trà Đào Lipton', NOW(), NOW(), 'Trà đào đóng chai Lipton.', 'https://via.placeholder.com/300x200?text=Lipton+Peach', 1.79, 1, 6),
(114, 'Trà Đá Pha Sẵn', NOW(), NOW(), 'Trà đen pha sẵn không đường.', 'https://via.placeholder.com/300x200?text=Iced+Tea', 1.29, 1, 6),
(115, 'Nước Cam Ép', NOW(), NOW(), 'Nước cam tươi ép.', 'https://via.placeholder.com/300x200?text=Orange+Juice', 2.49, 1, 6),
(116, 'Nước Chanh Tươi', NOW(), NOW(), 'Nước chanh tươi pha.', 'https://via.placeholder.com/300x200?text=Lemonade', 1.99, 1, 6),
(117, 'Cà Phê Đen Đá', NOW(), NOW(), 'Cà phê phin đen đá.', 'https://via.placeholder.com/300x200?text=Black+Coffee', 1.99, 1, 6),
(118, 'Cà Phê Sữa Đá', NOW(), NOW(), 'Cà phê phin sữa đá.', 'https://via.placeholder.com/300x200?text=Milk+Coffee', 2.29, 1, 6),
(119, 'Milo Đá', NOW(), NOW(), 'Thức uống lúa mạch Milo pha đá.', 'https://via.placeholder.com/300x200?text=Milo', 1.99, 1, 6),
(120, 'Nước Ngọt Ly Lớn (Refill)', NOW(), NOW(), 'Ly lớn tự chọn nước ngọt và có thể refill.', 'https://via.placeholder.com/300x200?text=Refill+Drink', 2.49, 1, 6);
