...
public interface OrderService {
    ...
    PageResponse<OrderInfoResponse> getUserOrders(Long userId, int page, int size, String sort, String direction, EOrderStatus statusFilter);
    ...
    @Transactional
    OrderInfoResponse confirmOrder(Long userId, Long orderId);

    @Transactional
    OrderInfoResponse completeOrder(Long userId, Long orderId);

    PageResponse<OrderInfoResponse> getAllOrdersAdmin(int page, int size, String sort, String direction, EOrderStatus statusFilter, Long userIdFilter, Integer branchIdFilter, String orderCodeFilter);
